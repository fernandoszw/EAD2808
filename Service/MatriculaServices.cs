...
namespace Ead2808.Service
{
    public class MatriculaService
    {
        ...
        public void CadastrarAluno()
        {
            ...
            if (!DateTime.TryParseExact(entradaData,
                                "dd/MM/yyyy",
                                new CultureInfo("pt-BR"),
                                DateTimeStyles.None,
                                out var nascimento))
            {
            Console.WriteLine("Erro: Data de nascimento inválida. Por favor, informe uma data válida.");
            return; // não tenta inserir
            }

            aluno.DataNascimento = nascimento;
        ...
        public void ListarCursos()
        {
            ...
            {
                Console.WriteLine($"ID: {curso.IdCurso}, Curso: {curso.NomeCurso}");
            }
        }
